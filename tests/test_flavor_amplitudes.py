...
test_transition_lambda_0_sigma_0_3 = test_flavor_amplitudes.flavor_matrix_elements(n=1, x_i = test_flavor_amplitudes.Lambda_b_0, y_j = test_flavor_amplitudes.Sigma_b_0)
print(test_transition_lambda_0_sigma_0_3)

test_transition_Xi_0_Xi_prime_0_1 = test_flavor_amplitudes.flavor_matrix_elements(n=1, x_i = test_flavor_amplitudes.Xi_0, y_j = test_flavor_amplitudes.Xi_prime_0)
print(test_transition_Xi_0_Xi_prime_0_1)

test_transition_Xi_0_Xi_prime_0_2 = test_flavor_amplitudes.flavor_matrix_elements(n=2, x_i = test_flavor_amplitudes.Xi_0, y_j = test_flavor_amplitudes.Xi_prime_0)
print(test_transition_Xi_0_Xi_prime_0_2)

test_transition_Xi_0_Xi_prime_0_3 = test_flavor_amplitudes.flavor_matrix_elements(n=3, x_i = test_flavor_amplitudes.Xi_0, y_j = test_flavor_amplitudes.Xi_prime_0)
